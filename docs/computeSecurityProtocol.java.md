...
| <code><a href="#@cdktf/provider-opc.computeSecurityProtocol.ComputeSecurityProtocol.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/provider-opc.computeSecurityProtocol.ComputeSecurityProtocol.toHclTerraform"></a>
