...
| <code><a href="#@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.Initializer.parameter.tags">tags</a></code> | <code>typing.List[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/opc/1.4.1/docs/resources/compute_security_rule#tags ComputeSecurityRule#tags}. |
...
| <code><a href="#@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.hasResourceMove">has_resource_move</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.moveFromId">move_from_id</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.moveToId">move_to_id</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.toHclTerraform"></a>
...
##### `has_resource_move` <a name="has_resource_move" id="@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.hasResourceMove"></a>
...
##### `move_from_id` <a name="move_from_id" id="@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.moveFromId"></a>
...
##### `move_to_id` <a name="move_to_id" id="@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.moveToId"></a>
