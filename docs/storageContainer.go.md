...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v6/storagecontainer"
...
| <code><a href="#@cdktf/provider-opc.storageContainer.StorageContainer.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
