...
| <code><a href="#@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.toHclTerraform"></a>
...
ComputeSecurityRule.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId),ComputeSecurityRule.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId, TerraformProvider provider)
```
