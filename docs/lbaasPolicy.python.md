...
| <code><a href="#@cdktf/provider-opc.lbaasPolicy.LbaasPolicy.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-opc.lbaasPolicy.LbaasPolicy.toHclTerraform"></a>
