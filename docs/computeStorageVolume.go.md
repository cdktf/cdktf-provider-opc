...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v5/computestoragevolume"
...
&computestoragevolume.ComputeStorageVolumeConfig {
	...
	StorageType: *string,
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v5.computeStorageVolume.ComputeStorageVolumeTimeouts,
	Uri: *string,
}
```
