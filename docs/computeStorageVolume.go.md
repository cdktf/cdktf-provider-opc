...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v6/computestoragevolume"
...
&computestoragevolume.ComputeStorageVolumeConfig {
	...
	StorageType: *string,
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v6.computeStorageVolume.ComputeStorageVolumeTimeouts,
	Uri: *string,
}
```
