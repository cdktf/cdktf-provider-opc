...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v6/lbaasserverpool"
...
&lbaasserverpool.LbaasServerPoolConfig {
	...
	Servers: *[]*string,
	Enabled: interface{},
	HealthCheck: github.com/cdktf/cdktf-provider-opc-go/opc/v6.lbaasServerPool.LbaasServerPoolHealthCheck,
	Id: *string,
	Tags: *[]*string,
	VnicSet: *string,
}
