...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v5/lbaasserverpool"
...
&lbaasserverpool.LbaasServerPoolConfig {
	...
	Servers: *[]*string,
	Enabled: interface{},
	HealthCheck: github.com/cdktf/cdktf-provider-opc-go/opc/v5.lbaasServerPool.LbaasServerPoolHealthCheck,
	Id: *string,
	Tags: *[]*string,
	VnicSet: *string,
}
