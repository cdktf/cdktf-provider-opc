...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v6/computestoragevolumesnapshot"
...
&computestoragevolumesnapshot.ComputeStorageVolumeSnapshotConfig {
	...
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v6.computeStorageVolumeSnapshot.ComputeStorageVolumeSnapshotTimeouts,
}
```
