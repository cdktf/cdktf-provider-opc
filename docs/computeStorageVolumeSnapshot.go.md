...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v8/computestoragevolumesnapshot"
...
&computestoragevolumesnapshot.ComputeStorageVolumeSnapshotConfig {
	...
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v8.computeStorageVolumeSnapshot.ComputeStorageVolumeSnapshotTimeouts,
}
```
