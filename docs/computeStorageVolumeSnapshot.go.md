...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v5/computestoragevolumesnapshot"
...
&computestoragevolumesnapshot.ComputeStorageVolumeSnapshotConfig {
	...
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v5.computeStorageVolumeSnapshot.ComputeStorageVolumeSnapshotTimeouts,
}
```
