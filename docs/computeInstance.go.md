...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v6/computeinstance"
...
&computeinstance.ComputeInstanceConfig {
	...
	Storage: interface{},
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v6.computeInstance.ComputeInstanceTimeouts,
}
```
