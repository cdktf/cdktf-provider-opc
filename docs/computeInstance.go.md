...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/computeinstance"
...
&computeinstance.ComputeInstanceConfig {
	...
	Storage: interface{},
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc.computeInstance.ComputeInstanceTimeouts,
}
```
