...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v5/computeinstance"
...
&computeinstance.ComputeInstanceConfig {
	...
	Storage: interface{},
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v5.computeInstance.ComputeInstanceTimeouts,
}
```
