...
| <code><a href="#@cdktf/provider-opc.lbaasCertificate.LbaasCertificate.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-opc.lbaasCertificate.LbaasCertificate.toHclTerraform"></a>
