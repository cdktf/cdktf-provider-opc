...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v3/computestorageattachment"
...
&computestorageattachment.ComputeStorageAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v3.computeStorageAttachment.ComputeStorageAttachmentTimeouts,
}
```
