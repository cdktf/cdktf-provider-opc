...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v6/computestorageattachment"
...
&computestorageattachment.ComputeStorageAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v6.computeStorageAttachment.ComputeStorageAttachmentTimeouts,
}
```
