...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v5/computestorageattachment"
...
&computestorageattachment.ComputeStorageAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v5.computeStorageAttachment.ComputeStorageAttachmentTimeouts,
}
```
