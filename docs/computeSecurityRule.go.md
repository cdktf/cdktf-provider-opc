...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v8/computesecurityrule"
...
| <code><a href="#@cdktf/provider-opc.computeSecurityRule.ComputeSecurityRule.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
