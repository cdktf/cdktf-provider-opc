...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v3/computesnapshot"
...
&computesnapshot.ComputeSnapshotConfig {
	...
	Id: *string,
	MachineImage: *string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v3.computeSnapshot.ComputeSnapshotTimeouts,
}
```
