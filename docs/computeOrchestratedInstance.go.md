...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v6/computeorchestratedinstance"
...
&computeorchestratedinstance.ComputeOrchestratedInstanceConfig {
	...
	Id: *string,
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v6.computeOrchestratedInstance.ComputeOrchestratedInstanceTimeouts,
}
```
