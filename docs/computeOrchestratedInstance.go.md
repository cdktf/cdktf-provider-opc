...
```go
import "github.com/cdktf/cdktf-provider-opc-go/opc/v4/computeorchestratedinstance"
...
&computeorchestratedinstance.ComputeOrchestratedInstanceConfig {
	...
	Id: *string,
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-opc-go/opc/v4.computeOrchestratedInstance.ComputeOrchestratedInstanceTimeouts,
}
```
