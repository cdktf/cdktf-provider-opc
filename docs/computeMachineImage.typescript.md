...
| <code><a href="#@cdktf/provider-opc.computeMachineImage.ComputeMachineImage.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opc.computeMachineImage.ComputeMachineImage.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opc.computeMachineImage.ComputeMachineImage.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/provider-opc.computeMachineImage.ComputeMachineImage.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/provider-opc.computeMachineImage.ComputeMachineImage.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/provider-opc.computeMachineImage.ComputeMachineImage.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/provider-opc.computeMachineImage.ComputeMachineImage.moveFromId"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/provider-opc.computeMachineImage.ComputeMachineImage.moveToId"></a>
...
computeMachineImage.ComputeMachineImage.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-opc.computeMachineImage.ComputeMachineImage.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-opc.computeMachineImage.ComputeMachineImageConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
