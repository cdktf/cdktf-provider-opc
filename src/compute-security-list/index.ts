...
export class ComputeSecurityList extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the ComputeSecurityList to import
  * @param importFromId The id of the existing ComputeSecurityList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/opc/1.4.1/docs/resources/compute_security_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opc_compute_security_list", importId: importFromId, provider });
      }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      outbound_cidr_policy: {
        value: cdktf.stringToHclTerraform(this._outboundCidrPolicy),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
