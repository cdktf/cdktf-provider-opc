...
export function computeStorageVolumeSnapshotTimeoutsToHclTerraform(struct?: ComputeStorageVolumeSnapshotTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ComputeStorageVolumeSnapshot extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the ComputeStorageVolumeSnapshot to import
  * @param importFromId The id of the existing ComputeStorageVolumeSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/opc/1.4.1/docs/resources/compute_storage_volume_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      collocated: {
        value: cdktf.booleanToHclTerraform(this._collocated),
        isBlock: false,
        type: "simple",
      ...
      parent_volume_bootable: {
        value: cdktf.booleanToHclTerraform(this._parentVolumeBootable),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      timeouts: {
        value: computeStorageVolumeSnapshotTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ComputeStorageVolumeSnapshotTimeouts",
      },
    };
