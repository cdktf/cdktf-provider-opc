...
export function computeInstanceNetworkingInfoToHclTerraform(struct?: ComputeInstanceNetworkingInfo | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function computeInstanceStorageToHclTerraform(struct?: ComputeInstanceStorage | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ComputeInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/opc/1.4.1/docs/resources/compute_instance#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ComputeInstance to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opc_compute_instance", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      boot_order: {
        value: cdktf.listMapperHcl(cdktf.numberToHclTerraform, false)(this._bootOrder),
        isBlock: false,
        type: "list",
      ...
      instance_attributes: {
        value: cdktf.stringToHclTerraform(this._instanceAttributes),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      reverse_dns: {
        value: cdktf.booleanToHclTerraform(this._reverseDns),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      networking_info: {
        value: cdktf.listMapperHcl(computeInstanceNetworkingInfoToHclTerraform, true)(this._networkingInfo.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ComputeInstanceNetworkingInfoList",
      },
      storage: {
        value: cdktf.listMapperHcl(computeInstanceStorageToHclTerraform, true)(this._storage.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ComputeInstanceStorageList",
      },
      timeouts: {
