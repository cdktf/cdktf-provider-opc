...
export function computeStorageAttachmentTimeoutsToTerraform(struct?: ComputeStorageAttachmentTimeouts | cdktf.IResolvable): any {
...
export function computeStorageAttachmentTimeoutsToHclTerraform(struct?: ComputeStorageAttachmentTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ComputeStorageAttachmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ComputeStorageAttachmentTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ComputeStorageAttachmentTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ComputeStorageAttachment extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opc_compute_storage_attachment";
  ...
  * @param importToId The construct id used in the generated config for the ComputeStorageAttachment to import
  * @param importFromId The id of the existing ComputeStorageAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/opc/1.4.1/docs/resources/compute_storage_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opc_compute_storage_attachment", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: ComputeStorageAttachmentConfig) {
    super(scope, id, {
      terraformResourceType: 'opc_compute_storage_attachment',
    ...
    this._storageVolume = config.storageVolume;
  ...
  // storage_volume - computed: false, optional: false, required: true
  private _storageVolume?: string; 
  public get storageVolume() {
    return this.getStringAttribute('storage_volume');
  }
  public set storageVolume(value: string) {
    this._storageVolume = value;
  }
  // Temporarily expose input value. Use with caution.
  public get storageVolumeInput() {
    return this._storageVolume;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts = new ComputeStorageAttachmentTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ComputeStorageAttachmentTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      storage_volume: cdktf.stringToTerraform(this._storageVolume),
      timeouts: computeStorageAttachmentTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      storage_volume: {
        value: cdktf.stringToHclTerraform(this._storageVolume),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      timeouts: {
        value: computeStorageAttachmentTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ComputeStorageAttachmentTimeouts",
      },
    };
