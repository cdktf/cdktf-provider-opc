// https://registry.terraform.io/providers/hashicorp/opc/1.4.1/docs/resources/compute_ip_address_prefix_set
...
export interface ComputeIpAddressPrefixSetConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class ComputeIpAddressPrefixSet extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opc_compute_ip_address_prefix_set";
  ...
  * @param importToId The construct id used in the generated config for the ComputeIpAddressPrefixSet to import
  * @param importFromId The id of the existing ComputeIpAddressPrefixSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/opc/1.4.1/docs/resources/compute_ip_address_prefix_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opc_compute_ip_address_prefix_set", importId: importFromId, provider });
      }
  ...
  * @param options ComputeIpAddressPrefixSetConfig
  */
  public constructor(scope: Construct, id: string, config: ComputeIpAddressPrefixSetConfig) {
    super(scope, id, {
      terraformResourceType: 'opc_compute_ip_address_prefix_set',
