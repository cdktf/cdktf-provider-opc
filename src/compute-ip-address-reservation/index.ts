...
export class ComputeIpAddressReservation extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the ComputeIpAddressReservation to import
  * @param importFromId The id of the existing ComputeIpAddressReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/opc/1.4.1/docs/resources/compute_ip_address_reservation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ip_address_pool: {
        value: cdktf.stringToHclTerraform(this._ipAddressPool),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
